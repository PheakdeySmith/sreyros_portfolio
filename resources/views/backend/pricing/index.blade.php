...
<div class="page-header bg-primary  position-relative m-3 border-radius-xl">
                    ...
                    <ul class="nav nav-pills nav-fill flex-row p-1" id="tabs-pricing" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link mb-0 active" id="tabs-iconpricing-tab-1" data-bs-toggle="tab"
                                href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/pricing-page.html#monthly"
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link mb-0" id="tabs-iconpricing-tab-2" data-bs-toggle="tab"
                                href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/pricing-page.html#annual"
                                role="tab" aria-controls="annual" aria-selected="false" tabindex="-1">
                                Annual
                            </a>
                        </li>
                    </ul>
    ...
    <div class="container">
        <div class="tab-content tab-space">
            <div class="tab-pane active" id="monthly" role="tabpanel"
                aria-labelledby="tabs-iconpricing-tab-1">
                <div class="row">
...
<div class="container my-6">
    ...
    <div class="row mt-4">
        <div class="col-lg-2 col-md-4 col-6 mb-4">
            <img class="w-100 opacity-9" src="{{ asset('backend/assets') }}/image/logo-coinbase.svg" alt="logo_coinbase">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
            <img class="w-100 opacity-9" src="{{ asset('backend/assets') }}/image/logo-nasa.svg" alt="logo_nasa">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
            <img class="w-100 opacity-9" src="{{ asset('backend/assets') }}/image/logo-netflix.svg" alt="logo_netflix">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
            <img class="w-100 opacity-9" src="{{ asset('backend/assets') }}/image/logo-pinterest.svg" alt="logo_pinterest">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
            <img class="w-100 opacity-9" src="{{ asset('backend/assets') }}/image/logo-spotify1.svg" alt="logo_spotify">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
            <img class="w-100 opacity-9" src="{{ asset('backend/assets') }}/image/logo-vodafone.svg" alt="logo_vodafone">
        </div>
    </div>
    <div class="row mt-8">
        <div class="col-md-6 mx-auto text-center">
            ...
            <div class="accordion" id="accordionRental">
                ...
                <div class="accordion-item mb-3">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                        ...
                        <div class="accordion-body text-sm opacity-8">
                            ...
                            sparked by it. And the people who are like offended by it, it doesn’t matter. Because it's
                            about motivating the doers. Because I’m here to follow my dreams and inspire other people to
                            follow their dreams, too.
                            <br>
                            We’re not always in the position that we want to be at. We’re constantly growing. We’re
                            constantly making mistakes. We’re constantly trying to express ourselves and actualize our
                            dreams. If you have the opportunity to play this game of life you need to appreciate every
                ...
                <div class="accordion-item mb-3">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                        data-bs-parent="#accordionRental">
                        <div class="accordion-body text-sm opacity-8">
                            The time is now for it to be okay to be great. People in this world shun people for being
                            great. For being a bright color. For standing out. But the time is now to be okay to be the
                            greatest you. Would you believe in what you believe in, if you were the only one who
                            believed it?
                            If everything I did failed - which it doesn't, it actually succeeds - just the fact that I'm
                            willing to fail is an inspiration. People are so scared to lose that they don't even try.
                            Like, one thing people can't say is that I'm not trying, and I'm not trying my hardest, and
                ...
                <div class="accordion-item mb-3">
                    ...
                    <div id="collapseFifth" class="accordion-collapse collapse" aria-labelledby="headingFifth"
                        ...
                        <div class="accordion-body text-sm opacity-8">
                            ...
                            skill. I’m not really specifically talented at anything except for the ability to learn.
