...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ps ps--active-y">
        ...
        <div class="container-fluid py-1 px-3">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Sweet Alerts</li>
                </ol>
            </nav>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <button class="btn btn-primary mb-0" onclick="soft.showSwal(&#39;basic&#39;)">Try
                                    me!</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <button class="btn btn-primary mb-0"
                                    onclick="soft.showSwal(&#39;success-message&#39;)">Try me!</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mt-4 mt-md-0">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <button class="btn btn-primary mb-0" onclick="soft.showSwal(&#39;custom-html&#39;)">Try
                                    me!</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <button class="btn btn-primary mb-0" onclick="soft.showSwal(&#39;input-field&#39;)">Try
                                    me!</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mt-4 mt-md-0">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <button class="btn btn-primary mb-0"
                                    onclick="soft.showSwal(&#39;title-and-text&#39;)">Try me!</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mt-4 mt-md-0">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <button class="btn btn-primary mb-0" onclick="soft.showSwal(&#39;auto-close&#39;)">Try
                                    me!</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                <p class="card-text">...and by passing a parameter, you can execute something else for
                                    "Cancel"</p>
                                <button class="btn btn-primary mb-0"
                                    onclick="soft.showSwal(&#39;warning-message-and-cancel&#39;)">Try me!</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mt-4 mt-md-0">
                        <div class="card">
                            <div class="card-body text-center">
                                <p class="card-text">Right-to-left support for Arabic, Persian, Hebrew, and other RTL
                                    languages</p>
                                <button class="btn btn-primary mb-0" onclick="soft.showSwal(&#39;rtl-language&#39;)">Try
                                    me!</button>
                            </div>
                        </div>
                    </div>
    ...
    <div class="ps__rail-y" style="top: 0px; height: 800px; right: 0px;">
        <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 694px;"></div>
    </div>
</main>
