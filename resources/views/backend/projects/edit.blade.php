                    ...
                    <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('year') is-invalid @enderror" id="year" name="year" value="{{ old('year', $project->year) }}" required>
                                    @error('year')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('agency') is-invalid @enderror" id="agency" name="agency" value="{{ old('agency', $project->agency) }}">
                                    @error('agency')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Recommended size: 800x600px. Max file size: 2MB. Leave empty to keep current image.</small>

                                    @if($project->thumbnail)
                                    <div class="mt-2">
                                        <p class="mb-1">Current Thumbnail:</p>
                                        <img src="{{ asset('storage/' . $project->thumbnail) }}" alt="{{ $project->title }}" class="img-thumbnail" style="max-height: 150px;">
                                    </div>
                                    @endif
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('url') is-invalid @enderror" id="url" name="url" value="{{ old('url', $project->url) }}" placeholder="https://example.com">
                                    @error('url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="is_featured" name="is_featured" value="1" {{ old('is_featured', $project->is_featured) ? 'checked' : '' }}>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="uil uil-save me-1"></i> Update Project
                            </button>
